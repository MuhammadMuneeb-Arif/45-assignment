...
//TASK 11:
 ...
 //task 17:
 let Guest :string=["Muheeb","Ubaid","Haider","Saifullah"];
 ...
 //task 18:
 let placesToVisit:string[]=["SAUDIA ARABIA","KAZAKISTAN","SOUTH KOREA","CANADA","UNITED STATES OF AMERICA ","UNITED ARAB EMIRATES"];
...
console.log("Back to Original Order:", placesToVisit);
  ...
  //Task 19 
  let guestlists:string[]=["Muheeb","Ubaid"]
  let guest_invitation:number =guestlists.length
  console.log(`${guest_invitation} people are invited to the dinner.`);
  //task 20:
  let Country:string[]=["Bolivia","Russia","China","Mexico","Canada","venezuela","South Korea"];
  console.log("list of Country:");
  console.log(Country);
  //task 21:
  let Person: { name: string, Fathername: string, Age: number } = { name: "Muneeb", Fathername: "M.Arif", Age: 16 };
  console.log(Person);
  //task 22:
...
let name_2 : string="MUhammad Muneeb"
let name_3 : string="Muhammad Muneeb Ahmed"
...
let country: string[]=["PAKISTAN","BANGLADESH","MEXICO","RUSSIA"];
...
task 29:
 let favourite_fruit: string[]=["apple","banana","mango","orange"];
...
//task 30:
let users : string []=["Moiz","Mubeen","Hamza","Haider"]
...
task 32:
let current_users : String []=["Moiz","Mubeen","Hamza","Haider"]
let new_users : string []=["Mheeb","Ubaid","Saifullah","Mubeen","Faizullah"]

let current_users_lo : string []=current_users.map(users=> users.toLowerCase())
...
task 34:
let favourite_pizza : string []=["chicken tikka","fajita","chicken afghani"]
...
// task 35:
 let animals : string[]=["Zebra","Girrafe","Elephant"]
...
task 38:
function describe_city( city:string,country: string= 'United states of America.'): void{
...
const magician : string[] = ["Dynamo","Munawar Khan","Shahrukh Zahoor"]
show_magicians(magician)
task 42:

function making_great(magicians: string[]): void{
  for (let i=0; i < magicians.length; i++) {
    magicians[i] = magicians[i] + ` the Great`
  }
}

const magicians2 : string[]=["Dynamo","Munawar Khan","Shahrukh Zahoor"]
making_great(magicians2)
console.log(magicians2);

//task 43:

function making_great2(magicians: string[]):string[]{
...
const magician3: string[]=["Dynamo","Munawar Khan","Shahrukh Zahoor"]

const greatMagicians2: string[]= making_great2(magician3);
...
function createCar(manufacture: string, model: string, optional: Record<string , any ) : car {
 ...
 const favorite_car : car = createCar("Volkswagen","Buggati",{color: 'blue and black',year : '2024'})
